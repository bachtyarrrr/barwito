...
<script>
    let range = "";
        let dateEnd = "";
        let dateStart = "";
        $('#card-cash-advance').hide();
        $('#wrap-checkbox').hide();
        $('#wca-checkbox').change(function(e) {
            e.preventDefault();
            if ($(this).is(':checked')) {
                $('#card-cash-advance').show();
            } else {
                $('#card-cash-advance').hide();
            }
        });

        $('input[id="rangedate"]').daterangepicker({}, function(start, end, label) {
            ...
            startDate = moment(start.format('YYYY-MM-DD').split("-"));
            endDate = moment(end.format('YYYY-MM-DD').split("-"));
            ...
            $('input[id="start-end-date"]').daterangepicker({
                minDate: moment(dateStart, 'MM-DD-YYYY'),
                maxDate: moment(dateEnd, 'MM-DD-YYYY')
            });
        });
</script>
@endpush
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group" id="wrap-checkbox">
                                    <label>With Cash Advance <code>*</code></label>
                                    <input class="form-check-input mx-3" type="checkbox" id="wca-checkbox">
                        ...
                        <div class="card mt-5" id="card-cash-advance">
                            <div class="card-header">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="cash-advance-table" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>No.</th>
                                            <th>Category</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control float-right"
                                                    id="start-end-date" />
                                            </td>
                                            <td><select class="form-control select2"
                                                    placeholder="Select Region Destination..." style="width: 100%;">
                                                    <option>Centra Java</option>
                                                    <option>East Java</option>
                                                </select>
                                            </td>
                                            <td><select class="form-control select2"
                                                    placeholder="Select Branch Destination..." style="width: 100%;">
